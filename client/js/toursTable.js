...
function add_coupon(id){
     ...
     let str='';
        ...
        str+="<input type='date' onkeypress='return false' class='form-control 'name='startDate' id='startDate'placeholder='"+"enter Start Date here"+"'required>";
        str+="</div>"
        str+="<div id='name-group' class='form-group'>"
        str+="<label for='expiryDate'>expiryDate</label>"
        str+="<input type='date' onkeypress='return false' class='form-control 'name='expiryDate' id='expiryDate'placeholder='"+"enter expiryDate  here"+"'required>";
        str+="</div>"
        str+="<div id='name-group' class='form-group'>"
...
const addCouponRendererComponent = (params) => {
    ...
    btn.id="btnAddCouponTour"
      btn.onclick = function (e) {
        localStorage.setItem('startDateTour',params.data.date)
...
var columnDefs = [
    ...
    { field: 'date', sortable: true,unSortIcon: true,width: 125 },
    { field: 'duration', sortable:true,comparator:numberSort,unSortIcon: true,width: 125},
    { field: 'cost', sortable:true,comparator:numberSort,unSortIcon: true,width: 125},
    {field: "Delete",width: 160,
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                Object.entries(data).map((tours) => {
                  ...
                  global_id.push(tours[1].id)
                  
                 
                })
                
                localStorage.setItem('tourIdArr',global_id)
